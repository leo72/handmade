...
$_['entry_stock_subtract']    = 'Вычитать товар на складе:<br /><span class="help">Вычитать товар со склада во время оформления заказа.</span>';
...
$_['entry_shipping_session']  = 'Использовать сессии доставки:<br /><span class="help">Saves shipping quotes to session to avoid re-quoting unnecessarily. Quotes will only be re-quoted if cart or address is changed.</span>';
$_['entry_catalog_limit'] 	  = 'Количество вещей на страницу по умолчанию (Магазин):<br /><span class="help">Определяет, сколько позиций отображается на странице магазина (товары, категории и т.д.)</span>';
$_['entry_admin_limit']   	  = 'Количество вещей на страницу по умолчанию (Админка):<br /><span class="help">Определяет, сколько позиций отображается на странице админки (заказы, клиенты и т.д.)</span>';
